...
调用 ConductPlay ：生成剧情 玩家作为新上任的县官/巡察使，在赴任途中或到任伊始，参加一场由上级主持的“青苗法”推行宣讲会。会上，朝廷特使（或变法派官员）慷慨陈词，描绘了一幅“春贷秋还、抑制豪强、惠民利国”的美好蓝图。同时埋下第一处隐患，批准青苗法的贷款名册。玩家发现，名册上有明显的“被自愿”签名
...
调用 ConductPlay： 生成人物 玩家结识本地几位关键人物，补充人物关键信息
